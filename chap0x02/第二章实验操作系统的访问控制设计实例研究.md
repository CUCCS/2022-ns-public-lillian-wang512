...
- 以 android系统为研究对象
  - 当系统处于锁屏状态下接收到新短信时，不解锁情况下
    ...
    - 安卓上的 App : 以 **便签** 为例，在接管了系统短信功能和权限之后，是否会有一些不同的功能设定？
      ...
      ![bianqian-permission-information](img/bianqian-permission-information.jpg)
...
- 思考题：
  ...
  - 系统或第三方应用程序是否提供了上述功能的访问控制规则修改？如果修改默认配置，是提高了安全性还是降低了安全性？
    ...
    ![wanyiyun-location-information](img/wanyiyun-location-information.jpg)
  
    ![wanyiyun-permission-information](img/wanyiyun-permission-information.jpg)
  
    ![Douban](img/Douban-notification-information.jpg)
  
    ![taobao](img/taobao-permission-location.jpg)
...
![ports-picture](img/ports-picture.png)
...
![tengxunvideo-login](img/tengxunvideo-login.png)

![Mobile-WeChat-login](img/Mobile-WeChat-login.jpg)
